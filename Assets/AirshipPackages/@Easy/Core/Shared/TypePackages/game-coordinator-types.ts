...
export namespace GameCoordinatorUserNotifications {
    ...
    export interface ClientSpec {
        getNotifications(options?: RequestOptions): Promise<{ notifications: EasyUserNotification[] }>;
        deleteNotifications(
            args: DeleteNotificationsArgs["data"],
            options?: RequestOptions,
        ): Promise<{ notifications: EasyUserNotification[] }>;
    }
    ...
    export class Client implements ClientSpec {
        ...
        async getNotifications(options?: RequestOptions): Promise<{ notifications: EasyUserNotification[] }> {
            return await this.makeRequest({
                method: "GET",
...
export namespace GameCoordinatorUserStatus {
    ...
    export type UpdateUserStatusResponse = UserStatusData & { refreshIn: number; notifiedRecipients: boolean };
